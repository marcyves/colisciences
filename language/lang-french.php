...
define("_WAITINGUSER","Utilisateurs en attente");
...
define("_YOURADMINLIST","Vous étes un administrateur: voici la liste des pages inactives:");
...
define("_ACCESSDENIED","Accés refusé");
define("_RESTRICTEDAREA","Vous essayez d'accéder é un espace réservé.");
define("_MODULEUSERS","Nous sommes désolé mais cette section de notre site est pour les <i>utilisateurs enregistrés seulement</i><br><br>Vous pouvez vous enregistrer gratuitement en cliquant <a href=\"user.php?op=new_user\">ici</a>, puis vous pouvez<br>accéder é cette section sans réstriction. Merci.<br><br>");
...
define("_YOURADMINENCY","Vous étes un administrateur, cette encyclopédie n'est pas active!");
...
define("_YOURADMININACTIVELIST","Vous étes un administrateur: regardez la liste des encyclopédies inactives:");
...
define("_SEARCHNOTCOMPLETE","Les options de la recherche sont incomplétes. Merci de recommencer.");

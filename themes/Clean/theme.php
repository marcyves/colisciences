  ...
  <tr> 
   <td> <img src=\"themes/$theme/img/logo.gif\" width=\"185\" height=\"134\" usemap=\"#Logo\" alt=\"CNRS - LCP - MediaTeC\">
      <map name=\"Logo\" id=\"Logo\">
        <area shape=\"rect\" coords=\"3,80,180,133\" href=\"http://www.ceram.fr/\" target=\"_blank\" alt=\"CERAM Business School\">
        <area shape=\"rect\" coords=\"3,5,160,70\" href=\"http://www.cnrs.fr/\" target=\"_blank\" alt=\"CNRS\">
      </map>
   </td>
...
<td class=\"tiny\">Dernières modifications: "
 ...
 <table width=\"100%\" height=\"20\" border=0 cellPadding=0 cellSpacing=0 class=\"boxcontent\">
<tr>
<td class=\"tiny2\">Copyright CNRS - 2002. <A HREF=\"modules.php?name=Informations\">Tous droits réservés</A>.</td>
<td class=\"tiny2\" align=\"right\">Nous contacter : <A HREF=\"mailto: gvignaux@mshparisnord.org\">CoLiSciences</A>.</td></tr></table>";
	}
			...
			<tr bgcolor="#e6e6e6">
				...
				<td width="100%">
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
						<tr>
							<td>
								<font class="tiny"><?php echo translate("Posted by "); ?> <?php formatAidHeader($aid) ?> <?php echo translate("on"); ?> <?php echo "$datetime $timezone"; ?> (<?php echo $counter; ?> <?php echo translate("reads"); ?>)</font>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr bgcolor="#e6e6e6">
				...
				<td width="100%">
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
						<tr>
							<td>
								<font class="tiny"><?php echo translate("Posted by "); ?> <?php formatAidHeader($aid) ?> <?php echo translate("on"); ?> <?php echo "$datetime $timezone"; ?></font>

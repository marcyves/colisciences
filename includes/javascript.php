...
if ($wysiwyg == 1) {
	echo '	<script language="JavaScript" type="text/javascript" src="includes/richtext.js"></script>';
/*	
	echo '<script type="text/javascript">';
	include("includes/richtext_compressed.js");
	echo '</script>';
*/
    echo "<script type=\"text/javascript\">\n";
    echo "<!--\n";

	...
	function showHideModule(divID, theme) {
		...
		if(w3c) {
			...
			if(divIDobj != null && tlobj != null && toggleobj != null) {
				ok=true;
				if(state=="c") {
					tlobj.src = "themes/Clean/spacer.gif";
//xxxxxx losqu'il y aura plusieurs themes actif, remettre +themes+ a la place de Clean....
					toggleobj.src = "themes/Clean/img/invisible.gif";
					divIDobj.style.display = "none";
				}
				else {
					tlobj.src = "themes/"+theme+"/spacer.gif";
//xxxxxx losqu'il y aura plusieurs themes actif, remettre +themes+ a la place de Clean....
					toggleobj.src = "themes/Clean/img/visible.gif";
	...
	function ResetModule(divID, theme) {
		...
		if(w3c) {
			...
			if(divIDobj != null && tlobj != null && toggleobj != null) {
				ok=true;
				if(state=="c") {
					tlobj.src = "themes/"+theme+"/img/spacer.gif";
					toggleobj.src = "themes/Clean/img/invisible.gif";
					divIDobj.style.display = "none";
				}
				else {
	...
	function MM_toggleItem(form, itemName, imageName, theme) {
		...
		if (MM_arrayContainsString(form.selectedItems, itemName)) {
			form.selectedItems = MM_removeStringFromArray(form.selectedItems, itemName);
					//xxxxxx losqu'il y aura plusieurs themes actif, remettre +themes+ a la place de Clean....
			document[imageName].src = 'themes/Clean/img/checkbox_off_16.gif';
			//MM_swapImage(imageName, '', 'themes/'+theme+'/checkbox_off_16.gif', '1');
		} else {
			form.selectedItems[form.selectedItems.length] = itemName;
					//xxxxxx losqu'il y aura plusieurs themes actif, remettre +themes+ a la place de Clean....
			document[imageName].src = 'themes/Clean/img/checkbox_on_16.gif';
		...
		if (form.checkboxes) {
			...
			for (i = 0; i < checkboxCount; i++) {
				...
				if (-1 == document[checkbox.mImageName].src.indexOf('dim_16.gif')) {
					...
					//xxxxxx losqu'il y aura plusieurs themes actif, remettre +themes+ a la place de Clean....
					document[checkbox.mImageName].src = 'themes/Clean/img/checkbox_on_16.gif';
				}
			}
		}
	...
	function MM_deselectAllItems(form,theme) {
		...
		if (form.checkboxes) {
			...
			for (i = 0; i < checkboxCount; i++) {
				...
				if (-1 == document[checkbox.mImageName].src.indexOf('dim_16.gif')) {
					//xxxxxx losqu'il y aura plusieurs themes actif, remettre +themes+ a la place de Clean....
					document[checkbox.mImageName].src = 'themes/Clean/img/checkbox_off_16.gif';
				}
			}
		}

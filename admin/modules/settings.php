...
//Language file includes updates to language definition for new features of this customization
/*if (isset($newlang)) { $language = $newlang; } elseif (isset($lang)) { $language = $lang; }
if(file_exists("language/user-$language.php")) { include("language/user-$language.php"); } else { include("language/user-english.php"); }*/
...
function Configure() {
    ...
    echo "<br>";
    CloseTable();
	echo "<br><a name=\"UserAddDelete\">";
	
	//Begin Customization for E-mail notifcation add-delete users
	OpenTable();
	echo "<center><font class=\"option\"><b>"._USERADDDELETE."</b></font></center>"
	."<table border=\"0\"><tr><td>"
	.""._ACTNOTIFYADD."</td><td>";
    if ($sendaddmail==1) {
	echo "<input type=\"radio\" name=\"xsendaddmail\" value=\"1\" checked>"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xsendaddmail\" value=\"0\">"._NO."";
    } else {
	echo "<input type=\"radio\" name=\"xsendaddmail\" value=\"1\">"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xsendaddmail\" value=\"0\" checked>"._NO."";
    }
    echo "</td></tr><tr><td>"
	.""._ACTALLOWDELETE."</td><td>";
    if ($allowuserdelete==1) {
	echo "<input type=\"radio\" name=\"xallowuserdelete\" value=\"1\" checked>"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xallowuserdelete\" value=\"0\">"._NO."";
    } else {
	echo "<input type=\"radio\" name=\"xallowuserdelete\" value=\"1\">"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xallowuserdelete\" value=\"0\" checked>"._NO."";
    }
    echo "</td></tr><tr><td>"
	.""._ACTNOTIFYDELETE."</td><td>";
    if ($senddeletemail==1) {
	echo "<input type=\"radio\" name=\"xsenddeletemail\" value=\"1\" checked>"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xsenddeletemail\" value=\"0\">"._NO."";
    } else {
	echo "<input type=\"radio\" name=\"xsenddeletemail\" value=\"1\">"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xsenddeletemail\" value=\"0\" checked>"._NO."";
    }
    echo "</td></tr><tr><td>"
	.""._ACTALLOWTHEME."</td><td>";
    if ($allowusertheme==1) {
	echo "<input type=\"radio\" name=\"xallowusertheme\" value=\"1\" checked>"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xallowusertheme\" value=\"0\">"._NO."";
    } else {
	echo "<input type=\"radio\" name=\"xallowusertheme\" value=\"1\">"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xallowusertheme\" value=\"0\" checked>"._NO."";
    }
    echo "</td></tr><tr><td>"
	.""._BLKUSRREG."</td><td>";
    if ($blkusrreg==1) {
	echo "<input type=\"radio\" name=\"xblkusrreg\" value=\"1\" checked>"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xblkusrreg\" value=\"0\">"._NO."";
    } else {
	echo "<input type=\"radio\" name=\"xblkusrreg\" value=\"1\">"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xblkusrreg\" value=\"0\" checked>"._NO."";
    }
    echo "</td></tr><tr><td>"
	.""._REQUIREADMIN."</td><td>";
    if ($requireadmin==1) {
	echo "<input type=\"radio\" name=\"xrequireadmin\" value=\"1\" checked>"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xrequireadmin\" value=\"0\">"._NO."";
    } else {
	echo "<input type=\"radio\" name=\"xrequireadmin\" value=\"1\">"._YES." &nbsp;"
	    ."<input type=\"radio\" name=\"xrequireadmin\" value=\"0\" checked>"._NO."";
    }
    echo "</td></tr></table>";
    echo "<br>";
	CloseTable();
    ...
    echo ""._TOPICSPATH.":</td><td><input type=\"text\" name=\"xtipath\" value=\"$tipath\" size=\"50\" maxlength=\"100\">"
        ."</td></tr><tr><td>";
    if ($userimg=="") {
    $userimg = "images/menu";
    }
    echo ""._USERPATH.":</td><td><input type=\"text\" name=\"xuserimg\" value=\"$userimg\" size=\"50\" maxlength=\"100\">"
        ."</td></tr><tr><td>";
    if ($adminimg=="") {
    $adminimg = "images/admin/";
    }
    echo ""._ADMINPATH.":</td><td><input type=\"text\" name=\"xadminimg\" value=\"$adminimg\" size=\"50\" maxlength=\"100\">"
        ."</td></tr></table>";
    CloseTable();
    echo "<br>";
    OpenTable();
...
function ConfigSave($xsitename, $xnukeurl, $xsite_logo, $xslogan, $xstartdate, $xadminmail, $xtop, $xstoryhome, $xoldnum, $xultramode, $xanonpost, $xDefault_Theme, $xbanners, $xfoot1, $xfoot2, $xfoot3, $xfoot4, $xbackend_title, $xbackend_language, $xlanguage, $xlocale, $xmultilingual, $xuseflags, $xnotify, $xnotify_email, $xnotify_subject, $xnotify_message, $xnotify_from, $xmoderate, $xcommentlimit, $xanonymous, $xadmingraphic, $xtipath, $xuserimg, $xadminimg, $xminpass, $xhttpref, $xhttprefmax, $xpollcomm, $xarticlecomm, $xsendaddmail, $xallowuserdelete, $xsenddeletemail, $xallowusertheme, $xblkusrreg, $xrequireadmin) {
    ...
    $content .= "\n";
	$content .= "$line";
	$content .= "# Mail New and deleted users to Admin Options\n";
	$content .= "# \$allowuserdelete: Allow users to delete their account (1=yes 0=no)\n";
	$content .= "# \$senddeletemail:  Notify admins of user deleting self (1=yes 0=no)\n";
	$content .= "# \$sendaddmail:     Notify admins of new user registration (1=yes 0=no)\n";
	$content .= "# \$allowusertheme:  Allow users to change themes (1=yes 0=no)\n";
	$content .= "# \$blkusrreg:       Allow users to create an account (1=yes 0=no)\n";
	$content .= "# \$requireadmin:    Require Admin to approve new users (1=yes 0=no)\n";
	$content .= "$line";
	$content .= "\n";
	$content .= "\$allowuserdelete = $xallowuserdelete;\n";
	$content .= "\$senddeletemail = $xsenddeletemail;\n";
	$content .= "\$sendaddmail = $xsendaddmail;\n";
	$content .= "\$allowusertheme = $xallowusertheme;\n";
	$content .= "\$blkusrreg = $xblkusrreg;\n";
	$content .= "\$requireadmin = $xrequireadmin;\n";
	$content .= "\n";
    $content .= "$line";

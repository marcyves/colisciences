...
function displayStory($qid) {
    ...
    if(ereg("MSIE", getenv("HTTP_USER_AGENT")))
         	{include "./modules/wysiwyg_editor/wysiwygeditor.php";
         	 jscript_wysiwyg();
         	 echo "<br><br><b>"._STORYTEXT."</b><br><br>";
         	 html_editor("hometext",$story,"myEditor");
         	 echo "<br><b>"._EXTENDEDTEXT."</b><br><br>";
         	 html_editor("bodytext",$storyext,"myEditor2");
         	}
         	else
         	{
    		echo "<br><br><b>"._STORYTEXT."</b><br>"
    ...
    echo "<font class=\"content\">"._AREYOUSURE."</font><br><br>"
	."<b>"._NOTES."</b><br>"
	...
	."</select>"
	."<input type=\"submit\" value=\""._OK."\" onClick=copyValue_hometext('myEditor');copyValue_bodytext('myEditor2');> &nbsp;&nbsp [ <a href=\"admin.php?op=DeleteStory&qid=$qid\">"._DELETE."</a> ]";
    CloseTable();
    echo "<br>";
...
function previewStory($automated, $year, $day, $month, $hour, $min, $qid, $uid, $author, $subject, $hometext, $bodytext, $topic, $notes, $catid, $ihome, $alanguage, $acomm, $pollTitle, $optionText) {
    ...
    if(ereg("MSIE", getenv("HTTP_USER_AGENT")))
         	{include "./modules/wysiwyg_editor/wysiwygeditor.php";
         	 jscript_wysiwyg();
         	 echo "<br><br><b>"._STORYTEXT."</b><br><br>";
         	 html_editor("hometext",$hometext,"myEditor");
         	 echo "<br><b>"._EXTENDEDTEXT."</b><br><br>";
         	 html_editor("bodytext",$bodytext,"myEditor2");
         	}
        	else
        	{ 	
	    	echo "<br><br><b>"._STORYTEXT."</b><br>"
	...
	."<option value=\"PostStory\">"._POSTSTORY."</option>"
	."</select>"
	."<input type=\"submit\" value=\""._OK."\" onClick=copyValue_hometext('myEditor');copyValue_bodytext('myEditor2');>";
    CloseTable();
    echo "<br>";
    putpoll($pollTitle, $optionText);
    echo "</form>";
...
function editStory($sid) {
	...
	if(ereg("MSIE", getenv("HTTP_USER_AGENT")))
	    	...
	    	."<input type=\"hidden\" name=\"op\" value=\"ChangeStory\">";
         	 echo "<br><br><input type=\"submit\" value=\""._SAVECHANGES."\" onClick=\"copyValue_hometext('myEditor');copyValue_bodytext('myEditor2');\">";
         	}
         	else
         	{
	    echo "<textarea wrap=\"virtual\" cols=\"50\" rows=\"7\" name=\"hometext\">$hometext</textarea><br><br>"
	    ."<b>"._EXTENDEDTEXT."</b><br>"
	    ."<textarea wrap=\"virtual\" cols=\"50\" rows=\"10\" name=\"bodytext\">$bodytext</textarea><br>"
...
function adminStory() {
    ...
    //========================= Wysiwyg Editor Only for Internet Explorer=======================
        if(ereg("MSIE", getenv("HTTP_USER_AGENT")))
         	{include "./modules/wysiwyg_editor/wysiwygeditor.php";
         	 jscript_wysiwyg();
         	 echo "<br><br><b>"._STORYTEXT."</b><br><br>";
         	 html_editor("hometext","","myEditor");
         	 echo "<br><b>"._EXTENDEDTEXT."</b><br><br>";
         	 html_editor("bodytext","","myEditor2");

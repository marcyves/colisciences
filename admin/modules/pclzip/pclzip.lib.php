<?
// --------------------------------------------------------------------------------
// PhpConcept Library - Zip Module 1.1.1
// --------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------
  ...
  {
	include(dirname(__FILE__).'/pcltrace.lib.php');
  }
  if (!defined("PCLERROR_LIB"))
  {
    include(dirname(__FILE__).'/pclerror.lib.php');
  }
  ...
  function PclZip($p_zipname)
  {
    ...
    if (!function_exists('gzopen'))
    {
      ...
      die('<p>Abort '.basename(__FILE__).' : Missing zlib extensions');
    }
  ...
  /**
   * @return unknown
   * @param p_filelist unknown
   * @param p_add_dir = "" unknown
   * @param p_remove_dir = "" unknown
   * @desc Cette methode crée une nouvelle archive conctenant les fichiers spécifiés
   */

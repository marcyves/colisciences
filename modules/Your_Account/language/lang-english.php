...
/*****************************************************/
/* From file : modules/Your_Account/index.php        */
/*****************************************************/
/*Confirm Password*/
/*Desired Password*/
/*Recommended*/
define("_OR","or");
define("_YOUBAD","You have attempted to perform an illegal operation!");
define("_SUREDELETE","Are you sure you want to delete your account?");
define("_ACCTDELETED","Your account has been removed from our server!");
define("_DELETEACCT","Delete<br>Account");
define("_CHANGEACCT","Change<br>Info");
...
define("_IFAPRPASSWILLSEND","(If your application is approved by the site admin,<br>your password will be sent to the email address you enter)");

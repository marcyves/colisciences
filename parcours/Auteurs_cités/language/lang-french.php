...
define("_NORESULTSTEXT","Aucun résultat dans le texte.");
define("_NORESULTSTITLE","Aucun résultat dans le titre.");
...
define("_RESULTSINTERMTITLE","Le terme choisi est soit défini, soit présent dans les titres suivants :");
define("_RESULTSINTERMTEXT","Le terme choisi est soit défini, soit présent dans les textes suivants :");

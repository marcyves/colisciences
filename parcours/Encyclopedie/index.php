...
function content($tid, $ltr, $page=0, $query="") {
	...
	if($page >= $pageno) {
	    ...
	    $next_page .= "<a href=\"parcours.php?name=$module_name&op=content&tid=$tid&page=$next_pagenumber$fromsearch\">"._NEXT." ($next_pagenumber/$pageno)</a> <a href=\"parcours.php?name=$module_name&op=content&tid=$tid&page=$next_pagenumber\"><img src=\"themes/$theme/img/right.gif\" border=\"0\" alt=\""._NEXT."\"></a>";
	}
	if($page <= 1) {
	    $previous_page = "";
	} else {
	    $previous_pagenumber = $page - 1;
	    $previous_page = "<a href=\"parcours.php?name=$module_name&op=content&tid=$tid&page=$previous_pagenumber$fromsearch\"><img src=\"themes/$theme/img/left.gif\" border=\"0\" alt=\""._PREVIOUS."\"></a> <a href=\"parcours.php?name=$module_name&op=content&tid=$tid&page=$previous_pagenumber$fromsearch\">"._PREVIOUS." ($previous_pagenumber/$pageno)</a>";
	}
	echo "<br>
	<center>$previous_page $next_page<br><br>"
	    .""._GOBACK."</center><br>";
	if (is_admin($admin)) {
